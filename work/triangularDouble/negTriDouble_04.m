...
figure('Name','Safety Factor (-0.4)','NumberTitle','off',...
    'FileName','SF-0.4.fig','Position',[10 10 1000 420])
subplot(1,2,1)
plot(p,q,'DisplayName','\delta=-0.4');
...
subplot(1,2,2)
plot(pavg,qavg,'DisplayName','\delta=-0.4')
xlabel('$\rho=\sqrt{\frac{\psi-\psi_0}{\psi_{\mathrm{LCFS}}-\psi_0}}$',latexParam{:})
...
figure('Name','Magnetic Shear (-0.4)','NumberTitle','off',...
    'FileName','MS-0.4.fig','Position',[10 10 1000 420])
subplot(1,2,1)
plot(p,q,'DisplayName','\delta=-0.4');
xlabel('$\rho=\sqrt{\frac{\psi-\psi_0}{\psi_{\mathrm{LCFS}}-\psi_0}}$',latexParam{:})
