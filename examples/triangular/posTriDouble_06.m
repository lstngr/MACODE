...
figure('Name','Safety Factor (+0.6)','NumberTitle','off',...
    'FileName','SF+0.6.fig','Position',[10 10 1000 420])
subplot(1,2,1)
plot(p,q,'DisplayName','\delta=+0.6');
...
subplot(1,2,2)
plot(pavg,qavg,'DisplayName','\delta=+0.6')
xlabel('$\rho=\sqrt{\frac{\psi-\psi_0}{\psi_{\mathrm{LCFS}}-\psi_0}}$',latexParam{:})
...
figure('Name','Magnetic Shear (+0.6)','NumberTitle','off',...
    'FileName','MS+0.6.fig','Position',[10 10 1000 420])
subplot(1,2,1)
plot(p,q,'DisplayName','\delta=+0.6');
xlabel('$\rho=\sqrt{\frac{\psi-\psi_0}{\psi_{\mathrm{LCFS}}-\psi_0}}$',latexParam{:})
